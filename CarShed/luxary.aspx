<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="luxary.aspx.cs" Inherits="CarShed.luxary" %>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [cid], [picone], [cmaker], [cname] FROM [cardetails] WHERE [catagory]='luxary'">
    </asp:SqlDataSource>
</asp:Content>
