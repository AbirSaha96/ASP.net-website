<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="muscle.aspx.cs" Inherits="CarShed.muscle" %>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [cid], [picone], [cmaker], [cname] FROM [cardetails] WHERE catagory='muscle'">
    </asp:SqlDataSource>
</asp:Content>
